...
var tweenOuter = TweenMax.to('#tagline-spinner-outer', 1, {
  rotation: 260,
  ease: Linear.easeNone,
});
// Build tween for inner
var tweenInner = TweenMax.to('#tagline-spinner-inner', 1, {
  rotation: -200,
  ease: Linear.easeNone,
});
// Build tween for donut icon
var tweenIcon = TweenMax.to('#tagline-spinner-donut', 1, {
  rotation: 80,
  ease: Linear.easeNone,
});
...
const logoAnimationContainer = document.querySelector('.lottie-wrapper');
